...
const Checkout_tsx_1 = __importDefault(require("./pages/Checkout.tsx"));
const router = (0, react_router_dom_1.createBrowserRouter)([
    {
        path: "/",
        element: (0, jsx_runtime_1.jsx)(App_tsx_1.default, {}),
    },
    {
        path: "/checkout",
        element: (0, jsx_runtime_1.jsx)(Checkout_tsx_1.default, {}),
    },
]);
