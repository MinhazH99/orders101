...
let storage = {};
let total = 0;
function submitOrder({ firstName, secondName, emailAddress, streetName, postCode, country, }) {
    updateOrder({
        firstName,
        secondName,
        emailAddress,
...
function updateOrderWithCustomerDetails({ order, firstName, secondName, emailAddress, streetName, postCode, country, }) {
    order.customer = {
